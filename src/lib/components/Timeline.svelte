...
<div class="w-full bg-black font-sans md:px-10">
	<div class="mx-auto w-full max-w-none px-4 py-20 sm:px-6 md:px-8 lg:px-10">
		<h2 class="mb-6 max-w-4xl text-4xl font-bold tracking-tighter text-white min-[380px]:text-5xl md:mb-8 md:text-7xl">
			{title}
		</h2>
		<p class="max-w-2xl text-base leading-relaxed text-white/40 md:text-xl">
			{description}
		</p>
	</div>
	...
	<div bind:this={timelineRef} class="relative z-0 mx-auto w-full max-w-none pb-20">
		{#each items as item, index}
			<div class="flex justify-start pt-12 md:gap-10 md:pt-40">
				<div
                ...
                <div class="relative w-full pl-16 pr-4 md:pl-4">
                    {#if renderItem}
